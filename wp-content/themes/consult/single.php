                ...
                <?php
                    ...
                    <div class="blog_left_side_area">
                        ...
                        <div class="share_blog_single_in_social">
                            <h4>
                                <span>Share</span>
                                <a href="http://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()) ?>" target="blank"><i class="fa fa-facebook"></i></a>
                                <a href="https://twitter.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()) ?>" target="blank"><i class="fa fa-twitter"></i></a>
                                <a href="https://plus.google.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()) ?>" target="blank"><i class="fa fa-google-plus"></i></a>
                                <a href="https://bd.linkedin.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()) ?>" target="blank"><i class="fa fa-linkedin"></i></a>
                            </h4>
                        </div>
