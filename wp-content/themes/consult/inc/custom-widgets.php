...
function blog_sidebar()
{
    register_sidebar(array(
        ...
        'id' => 'sidebar-blog',
        'description' => __( 'Widgets in this area ', 'theme-slug' ),
...
class consult_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'description' ) ); ?>" type="text" rows="6"><?php echo esc_attr( $description ); ?></textarea>
        </p>
        <?php
    }
