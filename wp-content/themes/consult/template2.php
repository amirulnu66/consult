        ...
        <div class="row">
            <div class="col-md-6">
                <div class="looking_for_left para_default">
                    <h3 style="color:<?php echo esc_html(cs_get_option('fields_4')); ?>"><?php echo esc_html( cs_get_option('fields_1')); ?></h3>
...
<div class="why_choose_us_area">
    <div class="container">
        <div class="row">
            ...
            <?php
            $servies_info = cs_get_option('service_area_101');
            if(is_array($servies_info)) :
                foreach($servies_info as $single_service): ?>

                    <div class="col-md-4 col-sm-6">
                        <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft">
                            <img src="<?php echo esc_url( wp_get_attachment_image_src($single_service['service_img_3'],'full')[0]); ?>" height="200">
                            <h3><?php echo esc_html($single_service['service_1']); ?></h3>
                            <p><?php echo esc_html($single_service['service_2']); ?> </p>
                        </div>
                    </div><!--col-md-4 -->
                <?php
                endforeach;
